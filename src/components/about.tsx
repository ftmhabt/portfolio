  ...
  return (
    <div className="sm:w-2/5">
      <div className="flex items-center gap-3">
        ...
        />
        <div>
          <div className="font-bold text-2xl">Hello, I'm Fatemeh Abtahi</div>
      ...
      <div className="my-5">
        ...
        development. No matter the project, I bring a collaborative spirit and a
        dedication to crafting exceptional user interfaces.
      </div>
